...
const FeatureIcon = ({ className, onClick }: IFeatureIcon) => {
  return (
    <svg
      className={className}
      onClick={onClick}
    ...
    >
      <g filter='url(#filter0_d_6_14286)'>
      ...
      <defs>
        ...
        >
          ...
          />
          <feBlend mode='normal' in2='BackgroundImageFix' result='effect1_dropShadow_6_14286' />
          <feBlend
            mode='normal'
            in='SourceGraphic'
            in2='effect1_dropShadow_6_14286'
            result='shape'
          />
        </filter>
      </defs>
